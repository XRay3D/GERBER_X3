...
protected:
    ...
    /*DXF*/
    inline static QString m_dxfDefaultFont { "Arial" };
    inline static bool m_dxfBoldFont { false };
    inline static bool m_dxfItalicFont { false };
    inline static bool m_dxfOverrideFonts { false };
