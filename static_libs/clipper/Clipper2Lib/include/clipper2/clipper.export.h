...
//// __________________________________
////
//// CPaths64 (int_t**) & CPathsD (double_t**):
...
// typedef int_t* CPath64;
// typedef int_t** CPaths64;
...
//         return nullptr;
//     const double scale = std::pow(10, precision);
//     Rect64 r = ScaleRect<int_t, double>(CRectToRect(rect), scale);
//     Paths64 pp = ConvertCPathsD(paths, scale);
//     class RectClip rc(r);
//     Paths64 result;
//     result.reserve(pp.size());
...
//     CPath64 result = new int_t[2 + cnt1 * 2];
//     result[0] = cnt1;
//     result[1] = cnt2;
//     return result;
// }
...
//    CPaths64 result = new int_t*[cnt2 + 1];
//    CPaths64 v = result;
