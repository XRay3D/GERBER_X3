...
Marker::~Marker() { App::setMarkers(type_, nullptr); }
...
QPainterPath Marker::shape() const { return App::scene()->drawPdf() ? QPainterPath() : path_; }

int Marker::type() const { return static_cast<int>(type_ ? GiType::MarkHome : GiType::MarkZero); }
