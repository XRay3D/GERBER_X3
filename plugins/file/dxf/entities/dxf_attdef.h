...
public:
    ...
    enum DataEnum {
        ...
        TextGenerationFlags = 71,             // see_TEXT_groupCodes Флаги создания текста (необязательно; значение по умолчанию = 0); см. u"Групповые коды TEXT"_s
        HorizontalTextJustificationType = 72, // see_TEXT_groupCodes Тип выравнивания текста по горизонтали (необязательно; значение по умолчанию = 0); см. u"Групповые коды TEXT"_s
