...
public:
    ...
    enum DataEnum {
        ...
        //        //    u"{имя_приложения"_s (необязательно)
        //        //    без значения по умолчанию
        //        //    коды, определенные в приложении
        //        //    Коды и значения в группах с кодом 102 определяются в приложении (необязательно)
        //        //    без значения по умолчанию
        //        E102 = 102,
        //        //    Конец группы, u"}"_s (необязательно)
        //        //    без значения по умолчанию
        //        E102 = 102,
        //        //    u"{ACAD_REACTORS"_s обозначает начало группы постоянных реакторов AutoCAD. Эта группа присутствует, только если постоянные реакторы были присоединены к данному объекту (необязательно)
        //        //    без значения по умолчанию

        SoftPointerID = 330, //    Идентификатор/дескриптор символьного указателя на словарь владельца (необязательно)
        //    без значения по умолчанию

        //        E102 = 102,        //    Конец группы, u"}"_s (необязательно)
        //        //    без значения по умолчанию
        //        E102 = 102,        //    u"{ACAD_XDICTIONARY"_s обозначает начало группы словаря расширения. Эта группа присутствует, только если словарь расширения был прикреплен к объекту (необязательно)
        //        //    без значения по умолчанию
