...
public:
    ...
    enum DataEnum {
        ...
        DummyX = 10,             // Файл DXF: всегда 0        // Приложение: u"фиктивная"_s точка; значения X и Y всегда равны нулю, а значение Z является отметкой полилинии (ОСК в 2D, МСК в 3D)
