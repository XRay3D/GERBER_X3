...
// ApplicationName = 1001,                   // Имя приложения расширенных данных, u"ACAD"_s (необязательно)
// XdataString = 1000,                       // Данные строк расширенных данных, u"DesignCenter Data"_s (необязательно)
// BeginXdata = 1002,                        // Начало расширенных данных, u"{"_s (необязательно)
...
// // 23 = ярды США
// // 24 = мили США
// EndXdata = 1002, // Конец расширенных данных, u"}"_s
// };
