...
public:
    ...
    virtual void readSettings(MySettings& settings) override {
        ...
        App::gcSettings().simplifyHldi_ = settings.getValue(chbxSimplifyHldi, App::gcSettings().simplifyHldi_);

        App::gcSettings().profileSort_ = settings.getValue(cbxProfileSort, App::gcSettings().profileSort_);
        settings.endGroup();
    }
    virtual void writeSettings(MySettings& settings) override {
        ...
        App::gcSettings().simplifyHldi_ = settings.setValue(chbxSimplifyHldi);

        App::gcSettings().profileSort_ = settings.setValue(cbxProfileSort);
        settings.endGroup();
    }
};
