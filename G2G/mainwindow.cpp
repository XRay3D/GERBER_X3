...
void MainWindow::createActionsGraphics()
{
    ...
    tb->setEnabled(false);
    tb->addAction(QIcon::fromTheme("draw-rectangle"), tr("Rect"), [=] { graphicsView->setPt(Rect); });
    tb->addAction(QIcon::fromTheme("draw-line"), tr("line"), [=] { graphicsView->setPt(Line); });
    tb->addAction(QIcon::fromTheme("draw-ellipse"), tr("Elipse"), [=] { graphicsView->setPt(Elipse); });
    tb->addAction(QIcon::fromTheme("draw-ellipse-arc"), tr("Arc"), [=] { graphicsView->setPt(ArcPT); });
    tb->addAction(QIcon::fromTheme("draw-text"), tr("Text"), [=] { graphicsView->setPt(Text); });
    tb->addSeparator();
